...
url = 'https://tuyensinhso.vn/diem-chuan/diem-chuan-cac-truong-dai-hoc-hoc-vien-khu-vuc-mien-nam-c47986.html'

def get_diem_chuan_mien_nam_link(url):
    diemchuanmiennamLink = []
    ...
    for link in links:
        ...
        if href and any(keyword in href for keyword in keywords) and not any(ex_keyword in href for ex_keyword in excluded_keywords):
            diemchuanmiennamLink.append(href)
    return diemchuanmiennamLink

result5_3 = get_diem_chuan_mien_nam_link(url)
print("Điểm chuẩn khu vực miền nam: ", result5_3)
print("------------------------------")

output_file = 'data_5_3.jsonl'
with jsonlines.open(output_file, mode='w') as writer:
    for link in result5_3:
...
output_markdown_file = 'output_5_3.md'
